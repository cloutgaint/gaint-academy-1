...
PARENT_PERMISSIONS=["platform.dashboard.view","students.student.view","attendance.session.view","learning.course.view","communication.notice.view","finance.plan.view","reports.summary.view"]
